...
public:
    ...
    void SetJavaVM(JavaVM *pjava_vm)
    { java_vm = pjava_vm; }

    void openCamera(JNIEnv *env,
                    jclass clazz,
                    jobject jPreviewSurface, jstring jOutPath);
    void captureCamera(JNIEnv *env, jobject clazz);
    void closeCamera(JNIEnv *env, jobject clazz);
    void FlipCamera(JNIEnv *env,
                    jclass clazz,
                    jobject jPreviewSurface, jstring jOutPath);
