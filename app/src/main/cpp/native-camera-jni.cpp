...
//jaehyek 현 파일은 다음에서 가져 왔다. 단순히 참조용으로. 즉 실제로는 아래의 code을 사용하지 않는다.
...
extern "C" jboolean
Java_android_hardware_camera2_cts_NativeCameraManagerTest_testCameraManagerGetAndCloseNative(
        JNIEnv *env, jclass /*clazz*/)
{
    ...
    LOGI("%s %s", __FUNCTION__, pass ? "pass" : "fail");
    if (!pass)
    {
...
extern "C" jboolean
Java_android_hardware_camera2_cts_NativeCameraManagerTest_testCameraManagerGetCameraIdsNative(
        JNIEnv *env, jclass /*clazz*/)
{
    LOGI("%s", __FUNCTION__);
    bool pass = false;
    ...
    LOGI("Number of cameras: %d", cameraIdList->numCameras);
    for (int i = 0; i < cameraIdList->numCameras; i++)
    {
        LOGI("Camera ID: %s", cameraIdList->cameraIds[i]);
    }
...
extern "C" jboolean
Java_android_hardware_camera2_cts_NativeCameraManagerTest_testCameraManagerAvailabilityCallbackNative(
        JNIEnv *env, jclass /*clazz*/)
{
    LOGI("%s", __FUNCTION__);
    bool pass = false;
    ...
    LOGI("%s %s", __FUNCTION__, pass ? "pass" : "failed");
    if (!pass)
    {
        throwAssertionError(env, errorString);
    }
...
extern "C" jboolean
Java_android_hardware_camera2_cts_NativeCameraManagerTest_testCameraManagerCharacteristicsNative(
        JNIEnv *env, jclass /*clazz*/)
{
    LOGI("%s", __FUNCTION__);
    bool pass = false;
    ...
    for (int i = 0; i < numCameras; i++)
    {
        ...
        for (int tid = 0; tid < numTags; tid++)
        {
            ...
            LOGI("%s capture request contains key %u", __FUNCTION__, tagId);
...
extern "C" jboolean
Java_android_hardware_camera2_cts_NativeCameraDeviceTest_testCameraDeviceOpenAndCloseNative(
        JNIEnv *env, jclass /*clazz*/)
{
    LOGI("%s", __FUNCTION__);
    int numCameras = 0;
...
extern "C" jboolean
Java_android_hardware_camera2_cts_NativeCameraDeviceTest_testCameraDeviceCreateCaptureRequestNative(
        JNIEnv *env, jclass /*clazz*/)
{
    LOGI("%s", __FUNCTION__);
    bool pass = false;
...
extern "C" jboolean
Java_android_hardware_camera2_cts_NativeCameraDeviceTest_testCameraDeviceSessionOpenAndCloseNative(
...
extern "C" jboolean
Java_android_hardware_camera2_cts_NativeCameraDeviceTest_testCameraDeviceSimplePreviewNative(
        JNIEnv *env, jclass /*clazz*/, jobject jPreviewSurface)
{
    LOGI("%s", __FUNCTION__);
    int numCameras = 0;
...
extern "C" jboolean
Java_android_hardware_camera2_cts_NativeImageReaderTest_testJpegNative(
...
extern "C" jboolean
Java_android_hardware_camera2_cts_NativeImageReaderTest_testImageReaderCloseAcquiredImagesNative(
        JNIEnv *env, jclass /*clazz*/)
{
    LOGI("%s", __FUNCTION__);
...
extern "C" jboolean
Java_android_hardware_camera2_cts_NativeStillCaptureTest_testStillCaptureNative(
